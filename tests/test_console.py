...
class TestConsole(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.assertIsInstance(f.getvalue(), str)
            self.assertEqual(
                f.getvalue().strip(), "Prints string representation of all instances."
            )
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.assertIsInstance(f.getvalue(), str)
            self.assertEqual(
                f.getvalue().strip(), "To get help on a command, type help <topic>."
            )
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_create_basemodel(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.assertIn(
                "BaseModel.{}".format(f.getvalue().strip()), storage.all().keys()
            )
    ...
    def test_update_basemodel(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.name = "KM"
            HBNBCommand().onecmd(f'update BaseModel {bm1.id} name "Ife"')
            self.assertEqual(bm1.__dict__["name"], "Ife")

        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.age = 75
            HBNBCommand().onecmd(f"update BaseModel {bm1.id} age 25")
            self.assertIn("age", bm1.__dict__.keys())
            self.assertEqual(bm1.__dict__["age"], 25)

        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.savings = 25.67
            HBNBCommand().onecmd(f"update BaseModel {bm1.id} savings 35.89")
            self.assertIn("savings", bm1.__dict__.keys())
            self.assertEqual(bm1.__dict__["savings"], 35.89)

        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.age = 60
            cmmd = f'update BaseModel {bm1.id} age 10 color "red"'
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", bm1.__dict__.keys())
            self.assertNotIn("color", bm1.__dict__.keys())
            self.assertEqual(bm1.__dict__["age"], 10)
...
class TestBaseModelDotNotation(unittest.TestCase):
    ...
    def test_show_basemodel(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.eyes = "red"
            HBNBCommand().onecmd(HBNBCommand().precmd(f"BaseModel.show({bm1.id})"))
            res = f"[{type(bm1).__name__}] ({bm1.id}) {bm1.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_basemodel(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            bm1.name = "KM"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'BaseModel.update({bm1.id}, name, "Ife")')
            )
            self.assertEqual(bm1.__dict__["name"], "Ife")
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            bm1.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f"BaseModel.update({bm1.id}, age, 25)")
            )
            self.assertIn("age", bm1.__dict__.keys())
            self.assertEqual(bm1.__dict__["age"], 25)
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.age = 60
            cmmd = f"BaseModel.update({bm1.id}, age, 10, color, red)"
    ...
    def test_update_basemodel_dict(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            bm1 = BaseModel()
            bm1.age = 75
            cmmd = f'BaseModel.update({bm1.id}, {{"age": 25,"color":"black"}})'
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertEqual(bm1.__dict__["age"], 25)
            self.assertIsInstance(bm1.__dict__["age"], int)
...
class TestUser(unittest.TestCase):
    ...
    def test_update_user(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            us = User()
            us.age = 60
            cmmd = f"update User {us.id} age 10 color red"
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", us.__dict__.keys())
...
class TestUserDotNotation(unittest.TestCase):
    ...
    def test_update_user(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            us = User()
            us.age = 75
            HBNBCommand().onecmd(HBNBCommand().precmd(f"User.update({us.id}, age, 25)"))
            self.assertIn("age", us.__dict__.keys())
            self.assertEqual(us.__dict__["age"], 25)
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            us = User()
            us.age = 60
            cmmd = f"User.update({us.id}, age, 10, color, red)"
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertIn("age", us.__dict__.keys())
            self.assertNotIn("color", us.__dict__.keys())
            self.assertEqual(us.__dict__["age"], 10)
...
class TestState(unittest.TestCase):
    ...
    def test_update_state(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            st = State()
            st.age = 60
            cmmd = f"update State {st.id} age 10 color red"
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", st.__dict__.keys())
...
class TestStateDotNotation(unittest.TestCase):
    ...
    def test_update_state(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            st = State()
            st.age = 60
            cmmd = f"State.update({st.id}, age, 10, color, red)"
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertIn("age", st.__dict__.keys())
            self.assertNotIn("color", st.__dict__.keys())
            self.assertEqual(st.__dict__["age"], 10)
    ...
    def test_destroy_state(self):
        ...
        with patch("sys.stdout", new=StringIO()):
            st = State()
            HBNBCommand().onecmd(HBNBCommand().precmd(f"State.destroy({st.id})"))
            self.assertNotIn("State.{}".format(st.id), storage.all().keys())
...
class TestPlace(unittest.TestCase):
    ...
    def test_show_place(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.eyes = "red"
            HBNBCommand().onecmd(f"show Place {plcll.id}")
            res = f"[{type(plcl).__name__}] ({plcl.id}) {plcl.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_place(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.name = "KM"
            HBNBCommand().onecmd(f'update Place {plcl.id} name "Ife"')
            self.assertEqual(plcl.__dict__["name"], "Ife")

        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.age = 75
            HBNBCommand().onecmd(f"update Place {plcl.id} age 25")
            self.assertIn("age", plcl.__dict__.keys())
            self.assertEqual(plcl.__dict__["age"], 25)

        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.age = 60
            cmmd = f"update Place {plcl.id} age 10 color red"
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", plcl.__dict__.keys())
            self.assertNotIn("color", plcl.__dict__.keys())
            self.assertEqual(plcl.__dict__["age"], 10)

    def test_destroy_place(self):
        """Test destroy place object."""
        with patch("sys.stdout", new=StringIO()):
            plcl = Place()
            HBNBCommand().onecmd(f"destroy Place {plcl.id}")
            self.assertNotIn("Place.{}".format(plcl.id), storage.all().keys())
...
class TestPlaceDotNotation(unittest.TestCase):
    ...
    def test_show_place(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.eyes = "red"
            HBNBCommand().onecmd(HBNBCommand().precmd(f"Place.show({plcl.id})"))
            res = f"[{type(plcl).__name__}] ({plcl.id}) {plcl.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_place(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            plcl.name = "KM"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Place.update({plcl.id}, name, "Ife")')
            )
            self.assertEqual(plcl.__dict__["name"], "Ife")
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            plcl.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f"Place.update({plcl.id}, age, 25)")
            )
            self.assertIn("age", plcll.__dict__.keys())
            self.assertEqual(plcl.__dict__["age"], 25)

        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.age = 60
            cmmd = f"Place.update({plcl.id}, age, 10, color, red)"
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertIn("age", plcl.__dict__.keys())
            self.assertNotIn("color", plcl.__dict__.keys())
            self.assertEqual(plcl.__dict__["age"], 10)
    ...
    def test_update_place_dict(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            plcl = Place()
            plcl.age = 75
            cmmd = f'Place.update({plcl.id}, {{"age": 25,"color":"black"}})'
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertEqual(plcl.__dict__["age"], 25)
            self.assertIsInstance(plcl.__dict__["age"], int)

    def test_destroy_place(self):
        """Test destroy place object."""
        with patch("sys.stdout", new=StringIO()):
            plcl = Place()
            HBNBCommand().onecmd(HBNBCommand().precmd(f"Place.destroy({plcl.id})"))
            self.assertNotIn("Place.{}".format(plcl.id), storage.all().keys())
...
class TestAmenity(unittest.TestCase):
    ...
    def test_update_amenity(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            am = Amenity()
            am.age = 60
            cmmd = f"update Amenity {am.id} age 10 color red)"
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", am.__dict__.keys())
...
class TestAmenityDotNotation(unittest.TestCase):
    ...
    def test_update_amenity(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            am = Amenity()
            am.age = 60
            cmmd = f"Amenity.update({am.id}, age, 10, color, red)"
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertIn("age", am.__dict__.keys())
            self.assertNotIn("color", am.__dict__.keys())
            self.assertEqual(am.__dict__["age"], 10)
    ...
    def test_destroy_amenity(self):
        ...
        with patch("sys.stdout", new=StringIO()):
            am = Amenity()
            HBNBCommand().onecmd(HBNBCommand().precmd(f"Amenity.destroy({am.id})"))
            self.assertNotIn("Amenity.{}".format(am.id), storage.all().keys())
...
class TestReview(unittest.TestCase):
    ...
    def test_update_review(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            rv = Review()
            rv.age = 60
            cmmd = f"update Review {rv.id} age 10 color red)"
            HBNBCommand().onecmd(cmmd)
            self.assertIn("age", rv.__dict__.keys())
...
class TestReviewDotNotation(unittest.TestCase):
    ...
    def test_update_review(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            rv = Review()
            rv.age = 60
            cmmd = f"Review.update({rv.id}, age, 10, color, red)"
            HBNBCommand().onecmd(HBNBCommand().precmd(cmmd))
            self.assertIn("age", rv.__dict__.keys())
            self.assertNotIn("color", rv.__dict__.keys())
            self.assertEqual(rv.__dict__["age"], 10)
    ...
    def test_destroy_review(self):
        ...
        with patch("sys.stdout", new=StringIO()):
            rv = Review()
            HBNBCommand().onecmd(HBNBCommand().precmd(f"Review.destroy({rv.id})"))
            self.assertNotIn("Review.{}".format(rv.id), storage.all().keys())
