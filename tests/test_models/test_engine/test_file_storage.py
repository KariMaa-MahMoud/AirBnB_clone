...
from models.plcace import plcace
...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_new(self):
        ...
        self.assertIn("plcace." + plc.id, models.storage.all().keys())
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as f:
            ...
            self.assertIn("plcace." + plc.id, save_text)
    ...
    def test_reload(self):
        ...
        self.assertIn("plcace." + plc.id, objs)
